...
if __name__ == "__main__":
    ...
    mat_a, mat_b, _ = LibsControl.c2d(model.mat_a, model.mat_b, model.mat_c, dt)

   
    lqri     = LibsControl.LQRDiscrete(mat_a, mat_b, q, r)
    ...
    error_sum = numpy.zeros((m, 1))
    
    steps = 0
    current_target_idx     = 0

    print("error_sum = ", error_sum.shape)
