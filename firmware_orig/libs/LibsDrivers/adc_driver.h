...
#define ADC_LINE_0                 ((unsigned int)ADC_Channel_0)    //PA0   - right sensor
...
#define ADC_LINE_7                 ((unsigned int)ADC_Channel_7)    //PA7   - left sensor

//IR sensors physical channels
#define ADC_IR_FRONT_LEFT           ((unsigned int)ADC_Channel_8)    //PB0
#define ADC_IR_LEFT                 ((unsigned int)ADC_Channel_9)    //PB1
#define ADC_IR_RIGHT                ((unsigned int)ADC_Channel_10)   //PC0
#define ADC_IR_FRONT_RIGHT          ((unsigned int)ADC_Channel_11)   //PC1
